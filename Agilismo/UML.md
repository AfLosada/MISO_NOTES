UML is a language that tries to abstract the way a system is modelled. This language, is a formal and complete language that is the industry standard for UML modelling. 
